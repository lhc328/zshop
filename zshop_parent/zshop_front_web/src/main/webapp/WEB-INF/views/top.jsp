    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content" id="login-account">
            <div class="modal-header">
                ...
                <h4 class="modal-title">用户名密码登录&nbsp;&nbsp;<small id="loginInfo" class="text-danger"></small>
                </h4>
            </div>
            ...
            <form class="form-horizontal" method="post" id="frmSms">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" type="text" placeholder="请输入验证码" id="verificationCode" name="verificationCode">
                        </div>
                        <div class="col-sm-2">
